...
//708813/1359841/2.50/3/4/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "IRF9540NPBF" (originalName "IRF9540NPBF")
	...
	(compDef "IRF9540NPBF" (originalName "IRF9540NPBF") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IRF9540NPBF"))
		...
		(attr "Mouser Part Number" "942-IRF9540NPBF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Infineon-Technologies/IRF9540NPBF?qs=9%252BKlkBgLFf0vnuA8mxUPtw%3D%3D")
		(attr "Manufacturer_Name" "Infineon")
		(attr "Manufacturer_Part_Number" "IRF9540NPBF")
		(attr "Description" "Infineon IRF9540NPBF P-channel MOSFET, 23 A, 100 V HEXFET, 3-Pin TO-220AB")
		(attr "<Hyperlink>" "https://www.infineon.com/dgdl/irf9540npbf.pdf?fileId=5546d462533600a401535611cfa21dc8")
		(attr "<Component Height>" "4.69")
		(attr "<STEP Filename>" "IRF9540NPBF.stp")
